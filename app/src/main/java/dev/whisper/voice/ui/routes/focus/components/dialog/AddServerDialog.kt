...
fun AddServerDialog(
    ...
    if (showDialog) {
        var serverName by rememberSaveable { mutableStateOf("") }  // state to hold the server name
        var serverAddress by rememberSaveable { mutableStateOf("") }// state to hold the server address
        var serverPort by rememberSaveable { mutableStateOf("") } // state to hold the server port
        var userName by rememberSaveable { mutableStateOf("") } // state to hold the user name
        var password by rememberSaveable { mutableStateOf("") } // state to hold the password
            ...
            text = {
                Column(
                    ...
                    Text(
                        ...
                        text = context.getString(R.string.add_server_dialog_title)
                    )
                    ...
                    OutlinedTextField(
                        ...
                        leadingIcon = {
                            Icon(
                                ...
                                contentDescription = context.getString(R.string.add_server_dialog_title)
                            )
                        },
